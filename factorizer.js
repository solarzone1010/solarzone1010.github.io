// BEGIN ALGEBRITE because I can't get import statements to work
...
function run(){
  let m = Algebrite.simplify(document.getElementById('m').value);
  let [a,b,c] = [Algebrite.coeff(m,2),Algebrite.coeff(m,1),Algebrite.coeff(m,0)];
